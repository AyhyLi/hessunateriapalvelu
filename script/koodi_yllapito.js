$(document).ready(function(){
    ...
    function tulostatuotteet(result){
        ...
        for(i=0; i < result.ruokalista.length; i++){
                ateriat +="<h1>" + result.ruokalista[i].nimi + "<span class='glyphicon glyphicon-remove ml10' data-toggle='modal' data-target='#myModal'></span><span class='glyphicon glyphicon-edit'></span></h1><div class='tiedot piilo'>" + result.ruokalista[i].ainekset + " <b>" + result.ruokalista[i].hinta  + "€</b></div>";
